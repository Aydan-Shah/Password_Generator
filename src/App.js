...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
      notify("Bir seçim edilməlidir!", true)
    }
    else {
      let characterList = ""
      if (includeNumbers) {
      ...
      notify("Parol uğurla yaradıldı", false)
    }
      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            <label htmlFor="password-strength">Şifrə uzunluğu</label>
          ...
          <div className="form-group">
            <label htmlFor="uppercase-letters">Böyük hərf əlavə et</label>
          ...
          <div className="form-group">
            <label htmlFor="lowercase-letters">Kiçik hərf əlavə et</label>
          ...
          <div className="form-group">
            <label htmlFor="include-numbers">Rəqəm əlavə et</label>
          ...
          <div className="form-group">
            <label htmlFor="include-symbols">Simvollar əlavə et</label>
